...
public class Othello implements Visitable{
	...
	public char getToken(int row, int col) {
		VisitorGetRC tv = new VisitorGetRC(row, col);
		char player = (char) accept(tv);
		return player;
	}
	...
	public boolean move(int row, int col) {
		VisitorMove vm = new VisitorMove(row, col);
		if ((boolean) accept(vm)) {
	...
	public int getCount(char player) {
		VisitorCount visitorCount = new VisitorCount(player);
		int count = (int) accept(visitorCount);
		return count;
	}
	 ...
	 */
	public Othello copy() {
		VisitorCopy vc = new VisitorCopy();
		Othello o = (Othello) accept(vc);
