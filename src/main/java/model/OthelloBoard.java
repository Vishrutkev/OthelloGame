...
public class OthelloBoard implements Visitable {
	...
	public OthelloBoard copy() {
		VisitorCopy visitorCopy = new VisitorCopy();
		OthelloBoard ob = (OthelloBoard) accept(visitorCopy);
		return ob;
	}
	...
	public char get(int row, int col) {
		VisitorGetRC visitorGetRC = new VisitorGetRC(row, col);
		char player = (char) accept(visitorGetRC);
		return player;
	}
	...
	public boolean move(int row, int col, char player) {
		if (!validCoordinate(row, col))
			return false;
		VisitorMove mv = new VisitorMove(row, col, player);
		boolean canMove = (boolean) accept(mv);
		return canMove;
	}
...
//	}
	...
	public int getCount(char player) {
		VisitorCount vc = new VisitorCount(player);
		int count = (int) accept(vc);
		return count;
	}
